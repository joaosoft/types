...
func (d *Date) Scan(src interface{}) error {
	...
	return errors.New(errors.LevelError, 0, "pq: cannot convert %T to %T", src, *d)
}
...
func (t *Time) Scan(src interface{}) error {
	...
	return errors.New(errors.LevelError, 0, "pq: cannot convert %T to %T", src, *t)
}
...
func (a *ListDay) Scan(src interface{}) error {
	...
	if err != nil {
		return errors.New(errors.LevelError, 0, "pq: cannot convert %T to Time", src)
	}
